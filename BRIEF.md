...
THEN a quality, professional README.md is generated with the 
- title of your project and    - done
- sections entitled 
 - Description,     - done
...
Installation,     - done
Usage,     - done
Contributing, and    - done 
Tests    - done

WHEN I choose a license for my application from a list of options
THEN a badge for that license is added hear the top of the README and a notice is added to the section of the README entitled License that explains which license the application is covered under    - done
